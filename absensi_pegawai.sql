...
--
-- Host: 127.0.0.1
-- Generation Time: May 02, 2020 at 02:41 PM
...
INSERT INTO `tabel_absensi` (`kode_absensi`, `id_pegawai`, `nama_pegawai`, `alamat_pegawai`, `tgl_absensi`, `waktu_kehadiran`, `jenis_kelamin`, `id_jabatan`, `nama_jabatan`, `id_bagian`, `nama_bagian`, `keterangan_absensi`) VALUES
('ABS_001', 'PG_001', 'Ahmad Basori', 'Jl.Salunggung RT.01 RW.02  Kota Malang', '2020-04-30', '2:44 AM', 'L', 'JBT_001', 'Direktur Bagian', 'BGN_001', 'IT Network', 'Terlambat '),
('ABS_002', 'PG_002', 'Kiki', 'Kediri', '2020-04-29', '03.00 AM', 'P', 'JBT_002', 'Supervisor', 'BGN_002', 'Marketing', NULL),
('ABS_003', 'PG_003', 'Kim Sung', 'Malang', '2020-04-30', '04.00 AM', 'L', 'JBT_003', 'Manager Bagian', 'BGN_003', 'HRD', NULL);
...
ALTER TABLE `tabel_absensi`
  ...
  ADD KEY `id_pegawai` (`id_pegawai`,`id_jabatan`,`id_bagian`),
  ADD KEY `tabel_absensi_ForeignKey_tabel_bagian` (`id_bagian`),
  ADD KEY `tabel_absensi_ForeignKey_tabel_jabatan` (`id_jabatan`);
